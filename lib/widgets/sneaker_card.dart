...
class SneakerCard extends StatefulWidget { // Changed to StatefulWidget
  final Shoe sneaker;
...
class _SneakerCardState extends State<SneakerCard> { // Added State class
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: widget.width,
      height: widget.height ?? 320, // Set a minimum height if not provided
      child: Card(
        ...
        child: InkWell( // Make the whole card tappable (optional)
          onTap: () {
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Image.network( // Changed from Image.asset
                            widget.sneaker.imageUrl, // Access sneaker via widget.
                            fit: BoxFit.contain, // Use contain to see the whole shoe
                            // Optional: Add error handling for image loading
                            errorBuilder: (context, error, stackTrace) {
                              print("Error loading image: ${widget.sneaker.imageUrl} - $error"); // Log error
                              return const Center(
                                  child: Column(
                    ...
                    Positioned(
                      ...
                      child: IconButton(
                        ...
                        style: IconButton.styleFrom( // Add background for visibility
                  ...
                  child: Column(
                    ...
                    children: [
                      // Brand Name
                       ...
                       Text(
                         widget.sneaker.name,
                         style: textTheme.bodyMedium, // Use bodyMedium for consistency
                       ...
                       Text(
                         'Lowest Ask',
                          style: textTheme.labelSmall?.copyWith(color: Colors.grey[600]), // Smaller grey label
                       ),
                       ...
                       Text(
                         ...
                         style: textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.bold), // Larger bold price
                         maxLines: 1,
                         overflow: TextOverflow.ellipsis,
                       ),

                       // Optional: Old Price (Strikethrough)
                       if (widget.sneaker.oldPrice != null && widget.sneaker.oldPrice! > widget.sneaker.price)
                         Padding(
