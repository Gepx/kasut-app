...
class IndonesianText {
  ...
  static final currencyFormatWithoutSymbol = NumberFormat.currency(locale: 'id_ID', symbol: '', decimalDigits: 0);
  ...
  static String formatPriceWithoutSymbol(double price) {
    return currencyFormatWithoutSymbol.format(price).trim();
  }
