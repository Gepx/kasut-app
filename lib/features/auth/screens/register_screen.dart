...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  static const Color _linkColor = Color(0xFF008080); // Teal-like color from image
        ...
        child: Padding(
          ...
          child: Form( // Wrap content in a Form
            ...
            children: [
              ...
              // Mobile Number Field
              Text('Mobile Number', style: textTheme.labelMedium?.copyWith(fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              Row(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Image.asset('assets/seller/indonesia_flag.png', width: 24, height: 16, fit: BoxFit.cover), // Using existing flag
              ...
              Text('Password Confirmation', style: textTheme.labelMedium?.copyWith(fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              _buildTextField(
                      ...
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(
                            ...
                            style: const TextStyle(color: _linkColor, fontWeight: FontWeight.bold),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: _agreeToTerms ? Colors.black : Colors.grey.shade300,
                  foregroundColor: _agreeToTerms ? Colors.white : Colors.grey.shade600,
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: const Text(
                      'Login here',
                      style: TextStyle(color: _linkColor, fontWeight: FontWeight.bold),
                    ),
                  ),
                ],
              ),
