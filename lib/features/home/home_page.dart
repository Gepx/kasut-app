...
import 'package:tugasuts/features/home/home_all.dart'; // Add import for CategoryAll
...
final List<Shoe> _sampleSneakers = [
  ...
  Shoe(
    ...
    imageUrl: 'https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/7ed0855435194229a525aad6009a0497_9366/Samba_OG_Shoes_White_B75806_01_standard.jpg',
   ...
   Shoe(
    ...
    brand: 'New Balance',
    price: 2800000,
    imageUrl: 'https://nb.scene7.com/is/image/NB/u990gr4_nb_02_i?pdpflexf2&qlt=80&fmt=webp&wid=440&hei=440',
  ...
  Shoe(
    ...
    brand: 'Asics',
    price: 2100000,
    imageUrl: 'https://images.asics.com/is/image/asics/1011B792_100_SR_RT_GLB?\$sfcc-product\$', // Escaped $
   ...
   Shoe(
    ...
    brand: 'Air Jordan',
    price: 1950000,
    imageUrl: 'https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/b7d9211c-26e7-431a-ac24-b0540fb3c00f/air-jordan-1-mid-shoes-86f1ZW.png',
  ...
  Shoe(
    ...
    brand: 'Puma',
    price: 1100000,
    imageUrl: 'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_600,h_600/global/374915/01/sv01/fnd/IND/fmt/png/Suede-Classic-XXI-Men\'s-Sneakers',
...
final List<String> _brands = [
  "All", "Air Jordan", "Adidas", "onCloud", "Nike", "Puma",
  "New Balance", "Asics", "Salomon", "Ortuseight", "Mizuno",
  "Under Armour", "Specs", "Yeezy"
];
...
final Map<String, BrandInfo> _brandInfo = {
  "Air Jordan": const BrandInfo(
    name: "Air Jordan",
    logoPath: "assets/brands/nike.png", // Using Nike logo since it's a Nike sub-brand
    description: "Air Jordan is a sub-brand of Nike created for basketball legend Michael Jordan. Launched in 1984, the iconic silhouettes have transcended sports to become cultural symbols representing peak athletic performance and street style.",
  ),
  "Adidas": const BrandInfo(
    name: "Adidas",
    logoPath: "assets/brands/adidas.png",
    description: "Founded in 1949 in Germany, Adidas is one of the world's largest sportswear manufacturers known for its three stripes logo. The brand combines performance technology with street-style designs across footwear, apparel, and accessories.",
  ),
  "onCloud": const BrandInfo(
    name: "onCloud",
    logoPath: "assets/brands/oncloud.png",
    description: "On is a Swiss running shoe company founded in 2010, known for its innovative CloudTec® cushioning technology. Their lightweight designs offer both comfort and performance for road and trail running.",
  ),
  "Nike": const BrandInfo(
    name: "Nike",
    logoPath: "assets/brands/nike.png",
    description: "Founded in 1964 as Blue Ribbon Sports, Nike has become the world's leading athletic footwear brand. Known for innovation in design and technology, Nike creates products for every type of athlete with its iconic Swoosh logo and 'Just Do It' slogan.",
  ),
  "Puma": const BrandInfo(
    name: "Puma",
    logoPath: "assets/brands/puma.png",
    description: "Established in 1948 in Germany, Puma is a global athletic and casual footwear brand known for blending sports performance with fashion-forward designs. Their iconic leaping cat logo represents speed and agility.",
  ),
  "New Balance": const BrandInfo(
    name: "New Balance",
    logoPath: "assets/brands/new_balance.png",
    description: "Founded in 1906, New Balance is renowned for its commitment to quality manufacturing and comfortable fit. The brand offers numeric widths in their shoes and maintains production facilities in the US and UK for premium lines.",
  ),
  "Asics": const BrandInfo(
    name: "Asics",
    logoPath: "assets/brands/asics.png",  // This logo may need to be added
    description: "Founded in 1949 in Japan, ASICS (Anima Sana In Corpore Sano - A Sound Mind in a Sound Body) specializes in performance running shoes with advanced cushioning technologies like GEL™ and FlyteFoam™ for injury prevention and comfort.",
  ),
  "Salomon": const BrandInfo(
    name: "Salomon",
    logoPath: "assets/brands/salomon.png",  // This logo may need to be added
    description: "Founded in 1947 in the French Alps, Salomon started as a ski equipment manufacturer. Today, they're known for technical trail running shoes and outdoor footwear designed for challenging terrains and weather conditions.",
  ),
  "Ortuseight": const BrandInfo(
    name: "Ortuseight",
    logoPath: "assets/brands/ortuseight.png",
    description: "Ortuseight is an Indonesian sports brand focusing on football and futsal footwear. Founded in 2018, they've quickly gained popularity in Southeast Asia for their quality and affordable performance shoes.",
  ),
  "Mizuno": const BrandInfo(
    name: "Mizuno",
    logoPath: "assets/brands/mizuno.png",
    description: "Founded in 1906 in Japan, Mizuno is known for premium quality sports equipment and footwear. Their running shoes feature Wave technology for cushioning and stability, popular among serious runners and athletes.",
  ),
  "Under Armour": const BrandInfo(
    name: "Under Armour",
    logoPath: "assets/brands/under_armour.png",
    description: "Founded in 1996, Under Armour began with moisture-wicking apparel and expanded to athletic footwear. Their HOVR™ cushioning and responsive designs cater to athletes looking for performance-driven shoes.",
  ),
  "Specs": const BrandInfo(
    name: "Specs",
    logoPath: "assets/brands/specs.png",
    description: "Specs is an Indonesian sports brand established in 1994, specializing in football, futsal, and running equipment. Known for their affordable yet durable products, they've become a popular choice in Southeast Asia.",
  ),
  "Yeezy": const BrandInfo(
    name: "Yeezy",
    logoPath: "assets/brands/yeezy.png",  // This logo may need to be added
    description: "Yeezy is a fashion collaboration between Kanye West and Adidas that began in 2015. Known for distinctive aesthetics, innovative materials, and limited releases, Yeezy sneakers have become highly collectible cultural icons.",
  ),
};
...
// HomePage is now StatelessWidget as TabController is managed in main.dart
...
class HomeAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const HomeAppBar({super.key, required this.tabController}); // Require controller
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  IconButton( // Use IconButton for better semantics
...
// Updated HomeBody to properly access TabController from parent
...
class _HomeBodyState extends State<HomeBody> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    // Create a local TabController that will be updated from the parent in didChangeDependencies
  ...
  void didChangeDependencies() {
    ...
    // Find the TabController from the nearest ancestor that has it
    final ancestorTabController = _findTabController(context);
    if (ancestorTabController != null && ancestorTabController != _tabController) {
      _tabController.dispose();
      _tabController = ancestorTabController;
    }
  }
  
  TabController? _findTabController(BuildContext context) {
    // Try to find the TabController in the context
    final scaffold = Scaffold.of(context);
    if (scaffold.widget.appBar is HomeAppBar) {
      return (scaffold.widget.appBar as HomeAppBar).tabController;
    }
    return null;
  }
  ...
  @override
  void dispose() {
    // Only dispose if we created it locally and it's not from the ancestor
    if (_findTabController(context) != _tabController) {
      _tabController.dispose();
    }
    super.dispose();
  }
    ...
    return TabBarView(
      ...
      children: _brands.map((brand) {
        if (brand == "All") {
          ...
          final filteredSneakers = ShoeData.shoes.where((shoe) => shoe.brand == brand).toList();
            ...
            child: AspectRatio(
              ...
              child: Image.asset(
                ...
                errorBuilder: (context, error, stackTrace) {
                  ...
                  return Icon(Icons.category, color: Colors.grey[400], size: 30);
                },
              ),
            ),
          ),
